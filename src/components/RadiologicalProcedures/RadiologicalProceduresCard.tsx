...
const RadiologicalProceduresCard = () => {
    const card = [
        ...
        },
        {
          ...
          description:
            "Tumor marker tests at Pathocon Diagnostics aid in the early detection and monitoring of cancer, enabling proactive healthcare and personalized treatment strategies for optimal outcomes.",
        },
        {
          id: 5,
          ...
          title: "Micorbiology",
          description:
            "Microbiology at Pathocon Diagnostics employs advanced techniques to identify and analyze microorganisms, facilitating accurate diagnoses and tailored treatment plans for infectious diseases.",
        },
        {
          id: 6,
          ...
          title: "Serology",
          description:
            "Serology at Pathocon Diagnostics investigates blood serum for antibodies, aiding in the diagnosis of various infections and autoimmune disorders with precision and comprehensive understanding.",
        },
        {
          id: 7,
          ...
          description:
            "Clinical Pathology at Pathocon Diagnostics focuses on analyzing bodily fluids and tissues, providing crucial insights for accurate disease diagnosis and optimal patient care.",
        },
        {
          id: 8,
          ...
          description:
            "Experience convenience with Pathocon Diagnostics – Blood Tests at Home. Book now for accurate and hassle-free healthcare services in the comfort of your space.",
        },
      ];
  return (
...
export default RadiologicalProceduresCard
